...
export { defineAction, getAction, listActions, hasAction, resolveBinding, detectConflicts } from '@features/shortcuts/registry';
...
export { parseChord, tryParseChord, stringifyChord, normalizeKey, normalizeCode, isStandaloneKey, ChordParseError } from '@features/shortcuts/parser';
