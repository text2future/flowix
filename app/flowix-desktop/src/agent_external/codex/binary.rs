...
use crate::agent_external::cli_resolver::{resolve_external_cli, ExternalCliSpec};
...
pub(crate) fn codex_candidate_paths() -> Vec<PathBuf> {
    crate::agent_external::cli_resolver::external_cli_candidate_paths(&CODEX_CLI_SPEC)
}
