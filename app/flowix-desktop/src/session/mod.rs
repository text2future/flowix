//! Session store — chat thread persistence, external-runtime session
...
// Re-export at the session:: namespace so callers can write
// `crate::session::ChatMessage` without dropping into `types`.
pub use error::*;
pub use store::*;
pub use types::*;
