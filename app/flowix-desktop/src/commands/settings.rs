//! 偏好 / AI 配置 IPC — `~/.flowix/preference.json` + `~/.flowix/flowix-ai-config.toml`。
//!
...
/// 用户偏好 (preference.json) — 走 ~/.flowix/preference.json
#[tauri::command]
...
/// AI 模型配置 (flowix-ai-config.toml) — 走 ~/.flowix/flowix-ai-config.toml
#[tauri::command]
