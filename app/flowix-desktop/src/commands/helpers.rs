...
pub(crate) fn switch_notebook_and_rebuild(
    ...
    switch_notebook(state, app, notebook_id, true, true);
}
...
pub(crate) fn switch_notebook_trusting_index(
    ...
    switch_notebook(state, app, notebook_id, false, false);
}
...
fn switch_notebook(
    ...
    if reconcile_disk {
        ...
        {
            tracing::warn!(
                "[switch_notebook_and_rebuild] reconcile_with_disk_bidirectional failed: {e}"
            );
        }
    }
