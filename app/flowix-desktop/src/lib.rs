...
use claude_cli::ClaudeCliManager;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::memo::list_memo_templates,
            commands::memo::save_memo_template,
            commands::memo::delete_memo_template,
            commands::memo::create_memo_from_template,
            // tag
